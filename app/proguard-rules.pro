...
-keep class com.flexath.ecommercemobile.data.** { *; }
-keep class com.flexath.ecommercemobile.domain.model.** { *; }
-keep class com.flexath.ecommercemobile.domain.repository.** { *; }